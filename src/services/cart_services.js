...
const BASE_URL = 'https://3.109.210.27:5200';
...
export const updateProductQty = async (productId, quantity, token, price) => {
  ...
  const response = await fetch("https://3.109.210.27:5200/cart/update", {
    method: "PUT",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
...
export const removeFromCart = async (productId, token) => {
  const response = await fetch("https://3.109.210.27:5200/cart/remove", {
    method: "POST",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
...
export const addToCart = async (productId, token) => {
  const response = await fetch("https://3.109.210.27:5200/cart/add", {
    method: "POST",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
