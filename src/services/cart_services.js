...
const BASE_URL = 'https://teaback.onrender.com/';
...
export const updateProductQty = async (productId, quantity, token, price) => {
  ...
  const response = await fetch("https://teaback.onrender.com/cart/update", {
    method: "PUT",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
...
export const removeFromCart = async (productId, token) => {
  const response = await fetch("https://teaback.onrender.com/cart/remove", {
    method: "POST",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
...
export const addToCart = async (productId, token) => {
  const response = await fetch("https://teaback.onrender.com/cart/add", {
    method: "POST",
    headers: {
      Authorization: `Bearer ${token}`,
      "Content-Type": "application/json",
